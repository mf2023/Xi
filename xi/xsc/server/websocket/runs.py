...
class XiRunsWebSocket:
    """
    WebSocket handler for runs management with real-time updates.
    """
    
    _instance: Optional['XiRunsWebSocket'] = None
    
    @classmethod
    def get_instance(cls, executor: XiExecutor, logger: XiLogger, root_dir: str = ".") -> 'XiRunsWebSocket':
        """Get or create the global runs WebSocket handler instance."""
        if cls._instance is None:
            cls._instance = cls(executor, logger, root_dir)
