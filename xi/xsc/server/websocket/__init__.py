...
from .runs import XiRunsWebSocket
...
class XiTrainingWebSocket:
    ...
    _instance: Optional['XiTrainingWebSocket'] = None
    
    @classmethod
    def get_instance(cls, executor: XiExecutor, root_dir: str, logger: XiLogger) -> 'XiTrainingWebSocket':
        """Get or create the global training WebSocket handler instance."""
        if cls._instance is None:
            cls._instance = cls(executor, root_dir, logger)
...
def setup_websockets(
    ...
    """
    _training_ws_handler = XiTrainingWebSocket.get_instance(executor, root_dir, logger)
    ...
    runs_handler = XiRunsWebSocket.get_instance(executor, logger, root_dir)
    ...
    monitor_handler = XiMonitorWebSocket.get_instance(logger, start_time, request_count)
    ...
    explorer_handler = XiExplorerWebSocket.get_instance(root_dir, logger)
    ...
    welcome_handler = XiWelcomeWebSocket.get_instance(logger)
