...
class XiWelcomeWebSocket:
    ...
    - XiWelcomeValidator: Configuration validation
    - XiWelcomeSetup: Environment setup
    - XiWelcomeAgreement: Agreement handling
    ...
    _instance: Optional['XiWelcomeWebSocket'] = None
    
    @classmethod
    def get_instance(cls, logger: XiLogger) -> 'XiWelcomeWebSocket':
    ...
    async def _handle_get_agreement(self, websocket: WebSocket) -> None:
        ...
        try:
            agreement_service = XiWelcomeAgreement.get_instance()
    ...
    async def _handle_validate_config(self, websocket: WebSocket) -> None:
        ...
        try:
            validator = XiWelcomeValidator.get_instance()
    ...
    async def _handle_setup_environment(self, websocket: WebSocket) -> None:
        ...
        try:
            setup = XiWelcomeSetup.get_instance()
