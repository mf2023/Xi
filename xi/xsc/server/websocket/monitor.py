...
class XiMonitorWebSocket:
    """
    WebSocket handler for system monitoring with real-time stats.
    """
    
    _instance: Optional['XiMonitorWebSocket'] = None
    
    @classmethod
    def get_instance(cls, logger: XiLogger, start_time: datetime = None, request_count: Dict[str, int] = None) -> 'XiMonitorWebSocket':
        """Get or create the global monitor WebSocket handler instance."""
        if cls._instance is None:
            cls._instance = cls(logger, start_time, request_count)
