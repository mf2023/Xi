...
class XiWelcomeAgreement:
    ...
    _instance: Optional['XiWelcomeAgreement'] = None
    
    @classmethod
    def get_instance(cls, project_root: Optional[Path] = None) -> 'XiWelcomeAgreement':
    ...
    def complete_first_launch(self) -> bool:
        ...
        try:
            ...
            XiConfigLoader.get_instance().reload()
